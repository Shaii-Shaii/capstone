...
const normalizeDonationDrive = (row, organization = null, registration = null) => ({
...
export const fetchDonationDrivePreview = async (driveId, databaseUserId = null) => {
  ...
  const [organizationsResult, registrationResult] = await Promise.all([
  ...
  return {
    ...
    error: driveResult.error || organizationsResult.error || registrationResult.error,
  };
};
